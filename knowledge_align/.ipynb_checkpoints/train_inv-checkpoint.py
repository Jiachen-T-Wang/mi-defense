...
eval_path = "/opt/tiger/vehiclereid/result/align/target_models/VGG16_reg.tar"
...
def main(args, trainloader, testloader, eval_model):
    ...
    torch.save({'state_dict':best_model.state_dict()}, os.path.join(save_model_path, "attack_{}_{}.tar".format(attack_name, target_name)))

    print("The best acc is {:.2f}".format(test_acc))
    print("The best l2 is {:.3f}".format(test_l2))
    print("==============================================================================")
