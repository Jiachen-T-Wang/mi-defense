...
if __name__ == "__main__":
    ...
    for epoch in range(epochs):
        ...
        torch.save({'state_dict':G.state_dict()}, os.path.join(save_model_dir, "celeba_G_600_v300.tar"))
        torch.save({'state_dict':DG.state_dict()}, os.path.join(save_model_dir, "celeba_D_600_v300.tar"))
